...
TEST(Constructor, string) {
    EXPECT_EQ(uint256_t("1010", 2), 10ULL);
    EXPECT_EQ(uint256_t("033", 8), 27ULL);
    EXPECT_EQ(uint256_t("1492", 10), 1492ULL);
    EXPECT_EQ(uint256_t("1492"), 1492ULL);
    EXPECT_EQ(uint256_t("000f", 16), 15ULL);

    EXPECT_EQ(uint256_t("\330\105\140\310\23\117\21\346\241\342\64\66\73\322\155\256", 256).str(), "287473478535710989927820548052301802926");
    EXPECT_EQ(uint256_t(std::string("\330\105\140\310\23\117\21\346\241\342\64\66\73\322\155\256", 16), 256).str(), "287473478535710989927820548052301802926");
    const char* uuid1 = "\330\105\140\310\23\117\21\346\241\342\64\66\73\322\155\256";
    EXPECT_EQ(uint256_t(uuid1, 256).str(), "287473478535710989927820548052301802926");
    const char uuid2[] = "\330\105\140\310\23\117\21\346\241\342\64\66\73\322\155\256";
    EXPECT_EQ(uint256_t(uuid2, 256).str(), "287473478535710989927820548052301802926");
}
