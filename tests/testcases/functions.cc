...
static const std::map <uint32_t, std::string> tests = {
	...
	// std::make_pair(256, "uint_t"),
};

TEST(Function, str) {
	const uint_t original(2216002924);
